...
if __name__ == "__main__":
    # if CFG.debug:
    #     part0_input, idxs = load_npy_files_efficiently(train_inputs_files, ratio=0.1, max_workers=32)
    #     part0_output = load_npy_files_efficiently(train_outputs_files, ratio=0.1, given_idxs=idxs, max_workers=32)
    #
