...
config = {
    ...
    "cosine_n_cycles": 0.5,
    "learning_rate": 8e-5,
    "resume": "../outputs/forcewithme_cnnlstm_cv0.7881_lb0.784/forcewithme_cnnlstm_cv0.7881_lb0.784.pt",
}
...
if __name__ == "__main__":
    ...
    if CFG.debug:
        weight = torch.load(CFG.resume,map_location=torch.device('cuda:0'))
