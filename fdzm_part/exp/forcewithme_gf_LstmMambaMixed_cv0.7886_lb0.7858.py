...
config = {
    ...
    "cosine_n_cycles": 0.5,
    "learning_rate": 8e-5,
    "resume": "../outputs/forcewithme_LstmMambaMixed_cv0.7884_lb0.7855/forcewithme_LstmMambaMixed_cv0.7884_lb0.7855.pt",
}
...
class LeapModel(nn.Module):
    def __init__(self, inputs_dim=25, num_lstm=3, hidden_state=256, d_state=16, d_conv=4, expand=2):
        super().__init__()
