...
if __name__ == "__main__":
    ...
    inputs_file_list = inputs_file_list_4+inputs_file_list_5 + inputs_file_list_6 + inputs_file_list_7 + inputs_file_list_8
    ...
    for input_file_ in tqdm(inputs_file_list):
        ...
        print(k)
        tmp_array_inputs = np.load(input_file_)
        ...
        #tmp_array_inputs = tmp_array_inputs[idxs,:]
    ...
    np.save(os.path.join(save_path, "sample4_inputs_v4.npy"), full_sample_inputs)