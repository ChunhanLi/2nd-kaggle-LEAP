...
if __name__ == "__main__":
    ...
    # debug
    for year_ in ['01','02','03','04','05','06','07','08','09']:
        for month_ in ['01','02','03','04','05','06','07','08','09','10','11','12']:
            # no data for 09/01 and 01/01
            if year_ == '09' and month_ != '01':
                continue
            if year_ == '01' and month_ in ['01']:
                continue
            
            print(f"=============year:{year_},month:{month_} start===============")
            ...
            data.set_regexps(data_split = 'train', 
                             regexps = [f'E3SM-MMF.mli.00{year_}-{month_}-*-*.nc']) # first month of year 8
            ...
            np.save(os.path.join(adam_data_path ,f"adam_full/train_{year_}_{month_}_inputs.npy"),inputs_array)
            print(2)
            # output part
            ...
            np.save(os.path.join(adam_data_path, f"adam_full/train_{year_}_{month_}_outputs.npy"),output_array)

            del inputs_array,output_array,train
            del data_loader,npy_iterator,npy_input,npy_output,train_npy,data
            gc.collect()
