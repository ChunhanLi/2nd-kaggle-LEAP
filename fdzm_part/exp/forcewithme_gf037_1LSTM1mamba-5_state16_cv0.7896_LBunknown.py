...
config = {
    ...
    "resume": "../outputs/forcewithme_1LSTM1mamba-5_state16_cv0.7886_LB0.7858/forcewithme_1LSTM1mamba-5_state16_cv0.7886_LB0.7858.pt",
}
...
if __name__ == "__main__":
    ...
    # else:
    model = nn.DataParallel(model.to(CFG.device), device_ids=[0,1,2,3,4,5,6])
